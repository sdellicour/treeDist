app <- ShinyDriver$new("../../")
app$snapshotInit("Influenza_Reconstruction")

app$uploadFile(tree_file_wo_transitions = "../../input/h3_small_sample.MCC.tre") # <-- This should be the path to the file, relative to the app's tests/shinytest directory
